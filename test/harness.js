...
window.__IV={
  ...
  hMain:(a,set,f)=>isoHouseMain(a,set|0,f|0), hTint:(o,a)=>isoHouseTint(o,a==null?1:a), hStage:(st,a)=>isoHouseStage(st,a==null?1:a),
  ...
  exch:()=>{ const b=exchangeOf(); return b? {id:b.id,tx:b.tx,ty:b.ty,w:b.w,h:b.h,owner:b.owner,
  ...
  vface:(u)=>u.vface!=null?u.vface:u.face,
